...
@Component
public class ReferenceMeasurementCommandProcessor {
    private static final Logger LOGGER = LoggerFactory.getLogger(ReferenceMeasurementCommandProcessor.class);
