 ...
 import org.apache.commons.math3.linear.*;    // ArrayRealVector, nicht nötig weil nur Kontrollausgabe
 import org.apache.commons.math3.util.*;      // Precision, ersetzen durch  Double.valueOf(new DecimalFormat("##.###").format(value))) oder Math.round(value*1000)/1000
 import java.io.*;

public class CallNonlinearFit {

    private CallNonlinearFit() {
    ...
    private void initializeHitran(OctaveEngine octave, String molecule) {
    ...
    private void getHitranData(OctaveEngine octave) {
	// get Hitran data
    ...
    private void getFtirData(OctaveEngine octave, String ftir_file_name) {
	// ftir data
    ...
    private void initializeLevenbergMarquardt(OctaveEngine octave, boolean nlcorr)  {
    ...
    private void startLevenbergMarquardt(OctaveEngine octave) {
    ...
    private void outputResult(OctaveEngine octave) {
	...
	CallNonlinearFit callNonlinearFit = new CallNonlinearFit();
    }


}//CallNonlinearFit class
